...
public class CommentController {
    ...
    public String updateCommentView(@PathVariable("id")Long commentId, Model model) {
    ...
    public String updateComment(CommentDto dto, @PathVariable("article_id")Long article_id, @PathVariable("comment_id")Long comment_id) {
